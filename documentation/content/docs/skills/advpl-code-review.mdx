...
2. **Analisar declaracoes de variaveis** - Verificar escopo (`Local` preferido), convencoes de nomenclatura (notacao hungara)
...
|---------|----------|---------|
| `BP` | Boas Praticas | `[BP-001]` RecLock sem MsUnlock |
